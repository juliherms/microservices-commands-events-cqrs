...
/**
 * This class responsible to configure Axon. Event Sourcing and Commands
 */
@Configuration
public class AxonConfig {
    ...
    /**
     * Method responsible to create and configure mongo connection
     * @return
     */
    @Bean
    ...
    /**
     * Method responsible to create a template connection for Axon
     * @return
     */
    @Bean
